...
public class DoubleOption extends ConfigOption<Double> {
    ...
    public static DoubleOption create(@NotNull Supplier<Double> defaultValue) { return new DoubleOption(defaultValue, Double.MIN_VALUE, Double.MAX_VALUE); }
    public static DoubleOption create(@NotNull Supplier<Double> defaultValue, double lowerLimit) { return new DoubleOption(defaultValue, lowerLimit, Double.MAX_VALUE); }
    public static DoubleOption create(@NotNull Supplier<Double> defaultValue, double lowerLimit, double upperLimit) { return new DoubleOption(defaultValue, lowerLimit, upperLimit); }
    ...
    private static class Parser implements ConfigParser<Double>
    {
        ...
        @NotNull
        @Override
        public String write(@NotNull Double value) { return value.toString(); }
    }
