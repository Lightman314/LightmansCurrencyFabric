...
public abstract class ConfigFile {
    ...
    protected final void forEach(@NotNull Consumer<ConfigOption<?>> action) { this.confirmSetup(); this.root.forEach(action); }
    @NotNull
    ...
    private static final class ConfigSection
    {
        ...
        Consumer<String> lineConsumer(@NotNull PrintWriter writer) { return ConfigFile.lineConsumer(writer,this.depth); }
    ...
    private static final class ConfigSectionBuilder
    {
        ...
        private ConfigSectionBuilder(@NotNull String name, int depth, ConfigSectionBuilder parent) { this.name = name; this.depth = depth; this.parent = parent; }
        ...
        private ConfigSection build(@Nullable ConfigSection parent, @NotNull ConfigFile file) { return new ConfigSection(this, parent, file); }
    }
}
