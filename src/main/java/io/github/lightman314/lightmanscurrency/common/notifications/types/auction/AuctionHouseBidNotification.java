...
public class AuctionHouseBidNotification extends AuctionHouseNotification{
    ...
    public static final Identifier TYPE = new Identifier(LightmansCurrency.MODID, "auction_house_outbid");
    ...
    public AuctionHouseBidNotification(NbtCompound compound) { this.load(compound); }
