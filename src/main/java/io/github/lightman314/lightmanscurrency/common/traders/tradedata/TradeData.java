...
public abstract class TradeData {
    ...
    protected void loadFromNBT(NbtCompound nbt)
    {
        cost.load(nbt, "Price");
    ...
    public abstract List<Text> GetDifferenceWarnings(TradeComparisonResult differences);
        ...
        public static class ProductComparisonResult {
            ...
            public static ProductComparisonResult CompareItem(ItemStack original, ItemStack query) {
                ...
                if(original.getNbt() != null)
                    isTagEqual = original.getNbt().equals(query.getNbt());
                else
                    isTagEqual = query.getNbt() == null;
     ...
     */
    public List<Text> getAdditionalTooltips(TradeContext context, int mouseX, int mouseY) { return null; }
     ...
     */
    public abstract void onInputDisplayInteraction(BasicTradeEditTab tab, @Nullable TraderStorageMenu.IClientMessage clientHandler, int index, int button, ItemStack heldItem);
     ...
     * @param heldItem The item being held by the player.
     */
    public abstract void onOutputDisplayInteraction(BasicTradeEditTab tab, @Nullable TraderStorageMenu.IClientMessage clientHandler, int index, int button, ItemStack heldItem);
     ...
     */
    public abstract void onInteraction(BasicTradeEditTab tab, @Nullable TraderStorageMenu.IClientMessage clientHandler, int mouseX, int mouseY, int button, ItemStack heldItem);
