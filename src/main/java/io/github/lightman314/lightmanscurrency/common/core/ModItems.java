...
public class ModItems {
	...
	public static final CapacityUpgradeItem ITEM_CAPACITY_UPGRADE_1 = new CapacityUpgradeItem(UpgradeType.ITEM_CAPACITY, LCConfig.SERVER.itemUpgradeCapacity1, new FabricItemSettings().group(LightmansCurrency.UPGRADE_GROUP));
	public static final CapacityUpgradeItem ITEM_CAPACITY_UPGRADE_2 = new CapacityUpgradeItem(UpgradeType.ITEM_CAPACITY, LCConfig.SERVER.itemUpgradeCapacity2, new FabricItemSettings().group(LightmansCurrency.UPGRADE_GROUP));
	public static final CapacityUpgradeItem ITEM_CAPACITY_UPGRADE_3 = new CapacityUpgradeItem(UpgradeType.ITEM_CAPACITY, LCConfig.SERVER.itemUpgradeCapacity3, new FabricItemSettings().group(LightmansCurrency.UPGRADE_GROUP));
