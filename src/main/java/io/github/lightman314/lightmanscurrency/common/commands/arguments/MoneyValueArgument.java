...
public class MoneyValueArgument implements ArgumentType<CoinValue> {
    ...
    private final CommandRegistryWrapper<Item> items;

    private MoneyValueArgument(CommandRegistryWrapper<Item> items) { this.items = items; }

    public static MoneyValueArgument argument(CommandRegistryAccess context) { return new MoneyValueArgument(context.createWrapper(Registry.ITEM.getKey())); }
