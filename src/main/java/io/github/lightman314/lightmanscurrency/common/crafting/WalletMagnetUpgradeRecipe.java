...
public class WalletMagnetUpgradeRecipe extends SpecialCraftingRecipe {
    ...
    public WalletMagnetUpgradeRecipe(Identifier id) { super(id); }
    ...
    private Optional<ItemStack> findWallet(CraftingInventory inventory)
    {
    ...
    private int upgradeItemCount(CraftingInventory inventory)
    {
        int count = 0;
        for(int i = 0; i < inventory.size(); ++i)
        {
