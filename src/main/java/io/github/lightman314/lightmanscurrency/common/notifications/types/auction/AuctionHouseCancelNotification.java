...
public class AuctionHouseCancelNotification extends AuctionHouseNotification{
    ...
    public static final Identifier TYPE = new Identifier(LightmansCurrency.MODID, "auction_house_canceled");
    ...
    public AuctionHouseCancelNotification(NbtCompound compound) { this.load(compound); }
