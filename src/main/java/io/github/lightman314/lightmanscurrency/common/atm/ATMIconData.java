...
public abstract class ATMIconData {
    ...
    public static final class IconType {
        ...
        private IconType(Identifier type, Function<JsonObject,ATMIconData> deserializer) {
            this.type = type;
            this.deserializer = deserializer;
        }

        public static IconType create(Identifier type, Function<JsonObject,ATMIconData> deserializer) { return new IconType(type, deserializer); }
