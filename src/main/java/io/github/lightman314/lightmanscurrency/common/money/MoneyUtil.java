...
public class MoneyUtil {
     ...
     */
    public static CoinValue getCoinValue(DefaultedList<ItemStack> inventory) { return new CoinValue(getValue(inventory)); }

    /**
     * Gets the total value of the items in the given ItemStack list.
     * @param inventory The list full of coins from which to get the value of.
     */
    public static long getValue(DefaultedList<ItemStack> inventory)
    {
        long value = 0;
