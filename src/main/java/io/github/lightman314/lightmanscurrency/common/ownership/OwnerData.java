...
public class OwnerData {
    ...
    private MutableText customOwner = null;
    ...
    public NbtCompound save()
    {
        ...
        if(this.customOwner != null)
            compound.putString("Custom", Text.Serializer.toJson(this.customOwner));
    ...
    public void load(NbtCompound compound)
    {
        if(compound.contains("Custom"))
            this.customOwner = Text.Serializer.fromJson(compound.getString("Custom"));
        else
