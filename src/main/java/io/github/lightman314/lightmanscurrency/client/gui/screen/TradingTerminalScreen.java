...
public class TradingTerminalScreen extends Screen implements IScrollable{
    ...
    protected void init()
    {
        ...
        this.searchField = this.addDrawableChild(new TextFieldWidget(this.textRenderer, guiLeft + 28, guiTop + 6, 101, 9, EasyText.translatable("gui.lightmanscurrency.terminal.search")));
