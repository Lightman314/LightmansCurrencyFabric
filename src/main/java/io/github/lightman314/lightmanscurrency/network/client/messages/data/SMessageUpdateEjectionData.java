...
public class SMessageUpdateEjectionData extends ServerToClientPacket {

    public static final Identifier PACKET_ID = new Identifier(LightmansCurrency.MODID, "datasync_ejectiondata_update");

    private final NbtCompound data;
    public SMessageUpdateEjectionData(NbtCompound data) { super(PACKET_ID); this.data = data; }
    ...
    public static void handle(MinecraftClient client, ClientPlayNetworkHandler handler, LazyPacketData data, PacketSender responseSender) {
        ClientEjectionData.UpdateEjectionData(data.getCompound("data"));
    }
